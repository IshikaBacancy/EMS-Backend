        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Leave_LeaveType", "LeaveType IN ('Sick', 'Casual', 'Vacation', 'Other')");
                    table.CheckConstraint("CK_Leave_Status", "Status IN ('Pending', 'Approved','Rejected')");
                    table.ForeignKey(
